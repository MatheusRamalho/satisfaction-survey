...
Uma pequena pesquisa de satisfação, com duas perguntas, uma de range e outra descritiva.
...
Você pode visualizar o deploy do projeto na vercel através [desse link](https://satisfaction-survey-mat.vercel.app/).
...
```bash
git clone https://github.com/MatheusRamalho/satisfaction-survey
```
